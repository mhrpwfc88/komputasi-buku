    ...
    <header class="absolute top-0 left-0 z-10 flex w-full items-center bg-transparent">
        <div class="container">
            <div class="relative flex items-center justify-between">
                <div class="px-4">
                    <a href="#home" class="block py-6 text-lg font-bold text-primary">Mh_ProCode</a>
                </div>
                <div class="flex items-center px-4">
                    ...
                    <nav id="nav-menu"
                        ...
                        <ul class="block lg:flex">
                            ...
                            <li class="group">
                                <a href="#about"
                                    class="mx-8 flex py-2 text-base text-dark group-hover:text-primary">Tentang kami</a>
                            </li>
                            <li class="group">
                                <a href="#portfolio"
                                    class="mx-8 flex py-2 text-base text-dark group-hover:text-primary">Buku</a>
                            </li>
                            <li class="group">
                                <a href="#clients"
                                    class="mx-8 flex py-2 text-base text-dark group-hover:text-primary">Informasi</a>
                            </li>
                            <li class="group">
                                <a href="#blog"
                                    class="mx-8 flex py-2 text-base text-dark group-hover:text-primary">blog</a>
                            </li>
                            <li class="group">
                                <a href="#contact"
                                    class="mx-8 flex py-2 text-base text-dark group-hover:text-primary">contact</a>
                            </li>
                            @if (Route::has('login'))
                                @auth
                                    <li>
                                        <a href="{{ url('/admin') }}"
                                            class="mx-8 flex py-2 text-base text-dark group-hover:text-primary">Dashboard</a>
                                    </li>
                                @else
                                    <li>
                                        <a href="{{ route('login') }}"
                                            class="mx-8 flex py-2 text-base text-dark group-hover:text-primary">Login</a>
                                    </li>
                                    @if (Route::has('register'))
                                        <li>
                                            <a href="{{ route('register') }}"
                                                class="mx-8 flex py-2 text-base text-dark group-hover:text-primary">Register</a>
                                        </li>
                                    @endif
                                @endauth
                    </nav>
            ...
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4 lg:w-1/2">
                    <h1 class="text-base font-semibold text-primary md:text-xl">
                        Hai Braderr 👋🤚, saya <span
                            class="mt-1 block text-4xl font-bold text-dark  lg:text-5xl">Muhammad Urip</span></h1>
                    ...
                    <p class="mb-10 font-medium leading-relaxed text-secondary ">
                        Saya seorang web developer yang berfokus pada pembuatan aplikasi web, saya juga seorang yang
                        suka belajar hal baru, dan saya juga suka berbagi ilmu kepada orang lain
                    </p>
            ...
            > -->
                ...
                <div class="w-full self-end px-4 lg:w-1/2">
                    <div class="relative mt-10 lg:right-0 lg:mt-9">
                        <img src="dist/img/logo1.png" alt="muhammad urip" class="mx-auto wit max-w-full" />
            ...
            <div class="flex flex-wrap">
                <div class="mb-10 w-full px-4 lg:w-1/2">
                    ...
                    <p class="max-w-xl text-base font-medium text-secondary lg:text-lg">
                        ...
                        itu saya menemukan nama itu ketika saya sedang belajar pemograman, dan saya ingin membuat nama
                        yang unik dan mudah di ingat oleh orang lain, dan akhirnya saya menemukan nama itu.
                    </p>
                </div>
                <div class="w-full px-4 lg:w-1/2">
                    ...
                    <p class="mb-6 text-base font-medium text-secondary lg:text-lg">
                        saya suka sekali berteman dan bersilatuhrahmi dengan orang lain, dan saya juga suka berbagi ilmu
                        kepada orang lain, dan saya juga suka belajar hal baru.
                        <br>
                    ...
                    <div class="flex items-center">
                        <!-- youtube -->
                        <a href="https://www.youtube.com/channel/UCOvhaCTftojD9M2u1AAkAnw" target="_blank"
                        ...
                        <a href="https://www.instagram.com/nata_wfc/" target="_blank"
                            class="text-sl mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                            <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- Github -->
                        <a href="https://github.com/mhrpwfc88" target="_blank"
                            class="text-sl mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                            <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <title>GitHub</title>
                        ...
                        <!-- link tree -->
                        <a href="https://mhcode.my.id" target="_blank"
                            class="text-sl mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                            <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="container">
            ...
            <div class="flex w-full flex-wrap justify-center px-4 xl:mx-auto xl:w-10/12">
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="overflow-hidden rounded-md shadow-md border-2 border-primary ">
                        <img src="{{ asset('storage/' . $buku->cover) }}" alt="Homepage" width="w-full" />
                    </div>
                    <h3 class="mt-5 text-xl font-semibold text-dark">{{$buku->judul}}</h3>
                    <p class="text-base font-medium text-dark">
                        Kategori : {{$buku->kategori ? $buku->kategori->nama : 'Tidak ada kategori'}}
                    </p>
            ...
            <div class="flex flex-wrap justify-center">
                ...
                <div class="xl-1/6 w-full px-4 lg:w-1/4">
                    <div class="mb-10 overflow-hidden rounded-xl bg-white shadow-lg">
                        <img src="dist/img/portfolio/daporaksan.png" alt="programmer" class="w-full" />
                        <div class="py-8 px-6">
                            <h3>
                                <a href="https://daporaksan.web.id"
                                    class="mb-3 block truncate text-xl font-semibold text-dark hover:text-primary">Daporaksan</a>
                            </h3>
                            <p class="mb-6 text-base font-medium text-secondary">
                                Data Potensi Kwaran Kraksaan
                            </p>
                            <a href="https://daporaksan.web.id"
                                class="rounded-lg bg-primary py-2 px-4 text-sm font-medium text-white hover:opacity-80">kunjungi
                                situsnya.</a>
                        </div>
                    </div>
                </div>
                <div class="xl-1/6 w-full px-4 lg:w-1/4">
                    <div class="mb-10 overflow-hidden rounded-xl bg-white shadow-lg">
                        <img src="dist/img/portfolio/lokacakti.PNG" alt="programmer" class="w-full" />
                        <div class="py-8 px-6">
                            <h3>
                                <a href="https://lokacakti.com"
                                    class="mb-3 block truncate text-xl font-semibold text-dark hover:text-primary">PT
                                    Loka Cakti indonesia</a>
                            </h3>
                            <p class="mb-6 text-base font-medium text-secondary">
        ...
        <div class="container">
            <div class="flex flex-wrap">
                ...
                <div class="mb-12 w-full px-4 md:w-1/3">
                    ...
                    <ul class="text-slate-300">
                        ...
                        <li>
                            <a href="#" class="mb-3 inline-block text-base hover:text-primary">web developer</a>
                        </li>
                    </ul>
                </div>
                <div class="mb-12 w-full px-4 md:w-1/3">
                    ...
                    <ul class="text-slate-300">
                        <li>
                            <a href="#" class="mb-3 inline-block text-base hover:text-primary">Beranda</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#clients" class="mb-3 inline-block text-base hover:text-primary">Informasi</a>
                        </li>
                        <li>
            ...
            <div class="w-full border-t border-slate-700 pt-10">
                ...
                <p class="text-center text-xs font-medium text-slate-500">
                    Dibuat oleh
                    <a href="https://www.instagram.com/nata_wfc/" target="_blank" class="font-bold text-primary">
                        Muhammad Urip</a>, Menggunakan
